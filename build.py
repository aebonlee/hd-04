...
STATS = '''    <div class="stats">
      ...
      <div class="stat"><b>11</b><span>수강생 프로젝트</span></div>
      ...
      <div class="cards">
        ...
        <div class="card">
          ...
          <p class="lead">수강생이 직접 쓴 기획서를 작업 지시서로 옮겨 개발한
            실전 업무 도구 11종입니다. 각자의 실제 업무 문제를 풀었습니다.</p>
...
page('index.html',
     ...
     hero('HD 생성형 AI 업무자동화 전문가과정 · 1차수',
          ...
          '수강생 기획서를 기반으로 개발한 실전 프로젝트(hd-project01~11)를 한 페이지에 정리했습니다.',
          STATS),
     HOME_BODY)
